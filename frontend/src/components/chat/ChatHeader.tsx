...
import { getNavItems } from '../layout/navigationConfig'

/**
 * Chat Header Component
 * 
 * Brand-aware header for the chat page.
 * Shows brand logo and name from context.
 */
    ...
    >
      <EuiHeaderSection grow={false}>
        <EuiHeaderSectionItem>
          ...
          >
            {brand.logo.svgDataUrl && !imgError ? (
              <EuiImage
