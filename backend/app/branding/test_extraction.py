    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            if logos:
                best = logos[0]
                print(
                    f"   Best candidate: score={best['score']}, reasons={best['reasons']}"
                )
        except Exception as e:
        ...
        try:
            ...
            print(
                f"   Top colors: {[c[0] for c in stylesheets['colors_by_frequency'][:5]]}"
            )
        except Exception as e:
        ...
        screenshot_path = (
            f"/tmp/branding_{url.replace('https://', '').replace('/', '_')}.png"
        )
