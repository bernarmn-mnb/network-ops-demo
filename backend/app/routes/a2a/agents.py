...
async def get_agents():
    ...
    try:
        ...
        if not agent_cards:
            return {"agents": [], "functions": [], "error": "No agent cards found"}
        ...
        return {"agents": enriched_agents, "functions": functions}

    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Failed to fetch agents: {e!s}")
...
async def get_agent(agent_id: str):
    ...
    try:
        ...
        return {"agent": agent_card, "function": function_def}

    except HTTPException:
        raise
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Failed to fetch agent: {e!s}")
