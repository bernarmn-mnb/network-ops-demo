                    ...
                    try:
                        ...
                        if "function_call" in continue_delta:
                            ...
                            if "name" in fc_d:
                                ...
                                fn_buffer[current_fn] = {"name": current_fn, "arguments": ""}
...
def handle_server_function(
    ...
    upstream = requests.post(url, headers=headers, json=payload_ab, stream=True, timeout=120)
